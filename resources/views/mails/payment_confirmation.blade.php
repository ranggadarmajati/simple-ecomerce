...
<center>
<p>Hi, Admin</p>
<p>Orderan dengan keterangan berikut sudah melakukan transfer:</p>
<table id="no_order">
	<tr>
...
<br>
<span>Silahkan cek bukti transfer dengan Login Aplikasi berikut: <a href="{{ env('MY_URL', 'http://localhost:8006') }}">www.echakids.com</a></span>
</center>
</div>