...
<center>
<p>Hi, {{ $mail['name'] }}</p>
<p>Pesanan Anda dengan No Order: <b>{{ $mail['order_no'] }}</b>, sudah dikirim Admin <a href="{{ env('MY_URL', 'http://localhost:8006') }}">www.echakids.com</a> ke Kurir {{ $mail['courier'] }} dengan paket {{ $mail['package'] }}</p>
<p>dengan No Tracking : <b style="color: red;">{{ $mail['tracking_number'] }}</b></p>
...
<p>Note: Untuk cek No Tracking pesanan anda bisa dicek di website resmi kurir yang anda pilih.</p>
<br>
