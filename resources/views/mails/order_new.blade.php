...
<center>
<p>Hi, Admin</p>
<p>Ada Orderan Baru dengan keterangan berikut:</p>
<table id="no_order">
	<tr>
...
<br>
<span>Silahkan Login Aplikasi dengan klik link berikut: <a href="{{ env('MY_URL', 'http://localhost:8006') }}">www.echakids.com</a></span>
</center>
</div>