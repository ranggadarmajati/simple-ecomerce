...
<div class="box box-warning color-palette-box">
    <div class="box-header with-border">
        <h3 class="box-title"><i class="fa fa-cubes"></i> Tambah Slide</h3>
    </div>
    <div class="box-body">
        {!! Form::open([
            'route' => 'admin.store_slide', 
            'role' => 'form',
        ...
        <div class="form-group">
            ...
            <input type="text" name="title" class="form-control" placeholder="Judul" required="required">
        </div>
        <div class="form-group">
            <label for="Deskripsi">Konten</label>
            <input type="text" name="description" class="form-control" placeholder="Konten" required="required">
        </div>
        <div class="form-group">
