...
<section class="content-header">
      <h1>
        Akun Bank
        <small>Edit Akun Bank</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Akun Bank</a></li>
        <li class="active">Edit Akun Bank</li>
      </ol>
    </section>
@stop
...
<div class="box box-warning color-palette-box">
    <div class="box-header with-border">
        <h3 class="box-title"><i class="fa fa-credit-card"></i> Edit Akun Bank</h3>
    </div>
    <div class="box-body">
        {!! Form::open([
            'route' => ['admin.update_baccount', $baccount->id ], 
            'role' => 'form',
        ...
        <div class="form-group">
            ...
            <input type="text" name="rek_no" class="form-control" placeholder="Nomor Rekening" value="{{ $baccount->rek_no }}" required="required">
        </div>
        <div class="form-group">
            <label for="bank">Nama Bank</label>
            <input type="text" name="bank" class="form-control" placeholder="Nama Bank" value="{{ $baccount->bank }}" required="required">
        </div>
        <div class="form-group">
            <label for="on_behalft">Atas Nama</label>
            <input type="text" name="on_behalft" class="form-control" placeholder="Atas Nama" value="{{ $baccount->on_behalft }}" required="required">
        </div>
        <div class="form-group">
